...
public class OneStaticFactory {
    ...
    public static void main(String[] args) {
        ...
        s2 = "ccc";
        System.out.println(++i);
        System.out.println(s1 == s2);    //3 true

        s1 = new String("ccc");
        s2 = new String("ccc");
        System.out.println(++i);
        System.out.println(s1 == s2);    //4 false

        s1 = new String("ddd").intern();
        s2 = new String("ddd").intern();
        System.out.println(++i);
        System.out.println(s1 == s2);    //5 true

        s1 = "ab" + "cd";
        s2 = "abcd";
        System.out.println(++i);
        System.out.println(s1 == s2);    //6 true
...
// 如果调用s1.intern 则最终返回true
        ...
        s2 = "ahh";
        System.out.println(++i);
        System.out.println(s1 == s2);    //9 true

        s1 = new String("1");    // 同时会生成堆中的对象 以及常量池中1的对象，但是此时s1是指向堆中的对象的
        s1.intern();            // 常量池中的已经存在
        s2 = "1";
        System.out.println(++i);
        System.out.println(s1 == s2);    //10 false
        ...
        System.out.println(++i);
        System.out.println(s3 == s4); //11 jdk1.7之前false， jdk1.7之后true

        s3 = new String("2") + new String("2");
        s4 = "22";        // 常量池中不存在22，所以会新开辟一个存储22对象的常量池地址
        s3.intern();    // 常量池22的地址和s3的地址不同
        System.out.println(++i);
        System.out.println(s3 == s4); //12 false

    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            for (int i = 0; i < CLIENT_QTY; i++) {
                ...
                clients.add(client);
                com.yzl.curator.ExampleClient exampleClient = new com.yzl.curator.ExampleClient(client, MASTER_PATH, "Client:" + i);
            ...
            for ( com.yzl.curator.ExampleClient exampleClient : examples ){

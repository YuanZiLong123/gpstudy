package com.yzl.zkjavaapi;

import com.yzl.zkclient.ZkClientApiOperatorDemo;
...
public class ApiOperatorDemo implements Watcher{
    private final static String CONNECTSTRING="47.98.209.24:2181";
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        ACL acl=new ACL(ZooDefs.Perms.ALL,new Id("ip","192.168.2.241"));

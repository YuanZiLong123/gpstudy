 ...
 * 
 */
@WebServiceClient(name = "SayHelloService", targetNamespace = "http://webservice.springcloud.yzl.com/", wsdlLocation = "http://localhost:8080/sayHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOSERVICE_QNAME = new QName("http://webservice.springcloud.yzl.com/", "SayHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/sayHello?wsdl");
    ...
    public SayHello getSayHelloPort() {
        return super.getPort(new QName("http://webservice.springcloud.yzl.com/", "SayHelloPort"), SayHello.class);
    }
    ...
    public SayHello getSayHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.springcloud.yzl.com/", "SayHelloPort"), SayHello.class, features);
    }
